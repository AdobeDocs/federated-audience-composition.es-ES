...
## ¿Qué permisos se requieren para acceder a Federated Audience Composition?
...
Para utilizar la composición de público federado, cada usuario debe añadirse a un perfil específico creado para cada zona protegida. Para obtener más información, consulte la página [Acceso a composición de público federado](./start/access-prerequisites.md).
...
Actualmente, son compatibles los siguientes almacenes en la nube:
...
Para obtener más información sobre cómo conectarse a un almacén de datos, lea la [descripción general de las conexiones](./connections/home.md).
...
Sí, puede eliminar audiencias de Composición de audiencia federada en Audience Portal.

+++

## Si combino datos de varias fuentes, ¿cómo los unimos? ¿Se usa el servicio de identidad?

+++ Respuesta

No, el servicio de identidad no se utiliza durante una composición. Los datos entre las distintas fuentes utilizadas en la composición se unen mediante una lógica definida por el usuario (tal y como se expresa en el modelo subyacente), por ejemplo, ID de CRM, número de cuenta de usuario, etc. Debe seleccionar la identidad que se utiliza como identificador en la audiencia para seleccionarla en el Data Warehouse. En un público resultante de la composición de público federado, debe identificar el espacio de nombres de identidad para la identidad en el conjunto de datos resultante.

+++

## ¿Cómo puedo crear y administrar solicitudes de privacidad con Federated Audience Composition?
