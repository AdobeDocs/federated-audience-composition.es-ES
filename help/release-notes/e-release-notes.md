...
Esta versión incluye los siguientes cambios y mejoras:

* **Disponibilidad del conector Oracle**

  El conector Oracle ya está disponible para su uso con la composición de público federado.

* **Alertas de estado de composición**

  Puede suscribirse a Alertas para recibir alertas sobre el éxito y los errores de las ejecuciones de composición.
...
* **Vista del lienzo del modelo de datos**
  ...
  La vista de lienzo de la sección Modelos de datos mejora la experiencia al permitir la visualización de los modelos de datos y sus vínculos en un diseño de lienzo, junto con la vista tabular existente. [Más información](../data-modelling/models.md)
...
* **Conexión segura de Snowflake**
  ...
  Con esta nueva versión, Federated Audience Composition admite conexiones PrivateLink seguras a bases de datos Amazon Redshift alojadas en Microsoft Azure. [Más información](../connections/home.md#amazon-redshift)
...
* **Conexión de Databricks**
  ...
  Con esta nueva versión, Federated Audience Composition ahora admite la conectividad PrivateLink para conexiones a bases de datos de Databricks.
  Esto incluye conexiones seguras a bases de datos de Databricks alojadas en Amazon Web Service (AWS) a través de PrivateLink y bases de datos de Databricks alojadas en Microsoft Azure a través de VPN. [Más información](../connections/home.md#databricks)
...
* **Conexión segura de Snowflake**
  ...
  Con esta nueva versión, Federated Audience Composition admite conexiones PrivateLink seguras a bases de datos de Snowflake alojadas en Microsoft Azure. [Más información](../connections/home.md#snowflake)
...
* **Experiencia mejorada de creación de esquemas**
  ...
  El proceso de creación de esquemas se ha mejorado a través de una interfaz de usuario actualizada, diseñada para ser más intuitiva y fácil de navegar. Estas mejoras ofrecen a los profesionales de los datos una forma más fluida y eficaz de desarrollar modelos de datos. [Más información](../data-modelling/schemas.md)
