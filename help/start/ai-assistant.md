...
1. Acceso al Asistente de IA mediante el icono de la barra superior.

   El Asistente de IA se muestra en la sección derecha de la pantalla. Puede seleccionar ![Profundizar texto alternativo de la imagen](assets/do-not-localize/Smock_FullScreen_18_N.svg "Expandir") para expandir la ventana del Asistente de IA.
