...
También permite conexiones seguras a bases de datos de Databricks alojadas en Amazon Web Service (AWS) y Microsoft Azure. [Más información](../connections/federated-db.md#databricks)
